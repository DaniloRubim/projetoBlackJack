    ...
    public partial class Form_jogo : Form
    {
        ...
        public void resultado()
        {
            ...
            /*
                ...
                jogador 1   x   jogador 2  Jogador 3    resultado
                <= 21           <= 21        <= 21      maior ponto ganha   REGRA 1
                > 21            <= 21        > 21       jogador 2 ganha     REGRA 2
                <= 21           > 21         <= 21      jogador 1 ganha     REGRA 3
                > 21            > 21         > 21       2 perderam          REGRA 4
                jogador 2       jogador 1   Jogador 2   EMPATE              REGRA 5
                jogador 3       Jogador 3   Jogador 1   EMPATE              REGRA 6
             */
            ...
            if (pontos_A > pontos_B && pontos_A > pontos_C && pontos_A <= 21)
                ...
                if (pontos_A < pontos_B && pontos_B > pontos_C && pontos_B <=21)
                lbl_Resultado.Text = "Jogador 2 GANHOU!";

            else
                    if (pontos_B > pontos_A && pontos_A < pontos_C && pontos_B <= 21)
                lbl_Resultado.Text = "Jogador 2 GANHOU!";
            else
                if (pontos_A < pontos_C && pontos_C <= 21)
                lbl_Resultado.Text = "Jogador 3 GANHOU!";
            
            else
                    if (pontos_B < pontos_C && pontos_C <= 21)
                lbl_Resultado.Text = "Jogador 3 GANHOU!";
            else
                    if (pontos_B > pontos_C && pontos_B > pontos_A && pontos_B <= 21)
                lbl_Resultado.Text = "Jogador 2 GANHOU!";

            else
                    if (pontos_C < pontos_A && pontos_A > pontos_B && pontos_A <= 21)
                lbl_Resultado.Text = "Jogador 1 GANHOU!";
